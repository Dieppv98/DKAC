...
namespace DKAC.Repository
{
    public class ReportRepository : IReportRepository
    {
        ...
        public List<RegisterByPersonalInfo> GetListRegisterReport(int month, int fromDate, int toDate, int emId)
        {
        ...
        public List<RegisterByPersonalInfo> GetListRegisterGroupByRoomId(int month, int fromDate, int toDate, int? roomId)
        {
            var query = from r in db.Registers
                        where r.RegisterDate.Month == month && r.RegisterDate.Day >= fromDate && r.RegisterDate.Day <= toDate
                        join e in db.Employees on r.EmployeeId equals e.id into le
